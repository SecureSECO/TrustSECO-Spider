...
class TestUserCount:
    ...
    def get_regular_body(self):
        with open('test_files/user_count/regular.txt', 'r') as regular:
            regular_body = regular.read()
        return regular_body

    def get_no_tag_body(self):
        with open('test_files/user_count/no_a_tag.txt', 'r') as no_tag:
            no_tag_body = no_tag.read()
        return no_tag_body

    def get_no_title_body(self):
        with open('test_files/user_count/no_title_attribute.txt', 'r') as no_title:
...
class TestIssueRatio:
    ...
    def get_regular_body(self):
        with open('test_files/issue_ratio/regular.txt', 'r', encoding='iso-8859-15') as regular:
            regular_body = regular.read()
        return regular_body

    def get_no_open_body(self):
        with open('test_files/issue_ratio/no_open_issues.txt', 'r', encoding='iso-8859-15') as no_open:
            no_open_body = no_open.read()
        return no_open_body

    def get_zero_open_body(self):
        with open('test_files/issue_ratio/zero_open_issues.txt', 'r', encoding='iso-8859-15') as zero_open:
            zero_open_body = zero_open.read()
        return zero_open_body

    def get_no_closed_body(self):
        with open('test_files/issue_ratio/no_closed_issues.txt', 'r', encoding='iso-8859-15') as no_closed:
            no_closed_body = no_closed.read()
        return no_closed_body

    def get_zero_closed_body(self):
        with open('test_files/issue_ratio/zero_closed_issues.txt', 'r', encoding='iso-8859-15') as zero_closed:
