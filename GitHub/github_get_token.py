...
class GitHubToken:
    """
    Class containing the functions needed to obtain a personal GitHub token
    """
    def authenticate_user(client_id):
        ...
        device_response = GitHubToken.request_device_token_info(client_id)
        ...
        user_token = GitHubToken.request_user_token(client_id, device_response)
