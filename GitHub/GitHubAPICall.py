...
class GitHubAPICall:
    ...
    def get_all_data(self, owner, repo, version, year, user_token):
        ...
        yearly_commit_count = self.get_yearly_commit_count(owner, repo, year, user_token)
    ...
    def get_repository_contributor_count(self, owner, repo, user_token):
        ...
        if (len(contributors_data.links) > 0):
    ...
    def get_yearly_commit_count(self, owner, repo, year, user_token):
